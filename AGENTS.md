<!--
  ...
  Skills fan-out: edit skills/<slug>/ only, then node scripts/generate-skills.mjs.
  Never hand-edit claude|cursor|codex|kiro|opencode|antigravity /skills or
  kiro/power/steering or client rules/*.mdc — see CONTRIBUTING.md.
-->
...
## CRITICAL — Do not hand-edit generated skills

Client skill trees are **build output**. Editing them directly is a known failure
mode (silent overwrite on the next generate, drift across tools, missing
`<!-- GENERATED FILE -->` headers).

| Edit these | Never hand-edit these |
| --- | --- |
| `skills/<slug>/SKILL.md` | `claude/skills/**`, `cursor/skills/**`, `codex/skills/**` |
| `skills/<slug>/rule.mdc.src.md` (optional) | `kiro/skills/**`, `opencode/skills/**`, `antigravity/skills/**` |
| `skills/rule-targets.json` | `kiro/power/steering/**` |
| `.loxtep/skills/<slug>.yaml` (optional) | `claude/rules/*.mdc`, `cursor/rules/*.mdc` |
...
# 2. Fan out + verify (CI runs --check)
node scripts/generate-skills.mjs
node scripts/generate-skills.mjs --check
```

Do **not** `cp` canonical files into client trees. Full detail: [CONTRIBUTING.md](CONTRIBUTING.md).
