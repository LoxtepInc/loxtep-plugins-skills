...
description:
  ...
  create_instance.
metadata:
  documentation: https://github.com/LoxtepInc/loxtep-plugins-skills/blob/main/antigravity/skills/loxtep-instances/SKILL.md
---
...
Bus table names for engineers: Node CLI `loxtep instances stream-config [<instance_id>]`,
SDK `client.workspace.instances.get_stream_config` (Node or Python), or REST
