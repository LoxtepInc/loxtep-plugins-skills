...
This gives you hosted MCP, 25 skills, and auth recovery. OAuth runs on first tool call.
...
|--------|----------|------|-------------|
| **Cursor** | Cursor IDE | [cursor/](cursor/) | Marketplace plugin **`loxtep`**. Hosted MCP, 25 skills, auth rule. |
| **Claude** | Claude Code & Cowork | [claude/](claude/) | Marketplace plugin **`loxtep-claude@loxtep`**. Hosted MCP, 25 skills, auth rule. |
| **OpenCode** | OpenCode | [opencode/](opencode/) | `opencode.json` (`type: remote`) + 25 skills. Native OAuth. |
| **Kiro** | Kiro IDE | [kiro/](kiro/) | Kiro Power (`kiro/power/`) or MCP config. 25 skills + 13 steering guides. |
| **Antigravity** | Google Antigravity | [antigravity/](antigravity/) | `~/.gemini/config/mcp_config.json` via `mcp-remote`. 25 skills in `~/.gemini/skills/`. |
